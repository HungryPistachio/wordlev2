...
function checkGuess() {
  ...
  } else if (!DICTIONARY.includes(guessString)) {
    alert("Well, that wasn't a real word!");
  }
  ...
  if (guessString === rightGuessString) {
    alert("Merry Christmas, you flithy animal, you got the right word!");
    guessesRemaining = 0;
    return;
  } else {
    guessesRemaining -= 1;
    ...
    if (guessesRemaining === 0) {
      ...
      //Swal.fire({
      // title: 'The right words was:',
      //text: "${rightGuessString}",
      //icon: 'info',
      //confirmButtonText: 'Thanks for rubbing it in.'
      //})
    }
  }
}
